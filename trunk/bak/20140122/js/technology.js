...
//	  $('#midashi').toggle("drop", {direction: "left"}, 1500);
	  $('#midashi').toggle("drop", {direction: "left"}, 1000);

//	  $('#gazou').toggle("drop", {direction: "up"}, 2000);
	  $('#gazou').toggle("drop", {direction: "up"}, 1000);

//	  $('#setsumei').toggle("drop", {direction: "right"}, 1500);
	  $('#setsumei').toggle("drop", {direction: "right"}, 1000);

  $('#work').click(function(){
//	    $('#midashi').toggle("drop", {direction: "left"}, 1500);
	    $('#midashi').toggle("drop", {direction: "left"}, 500);

//	    $('#setsumei').toggle("drop", {direction: "right"}, 1500);
	    $('#setsumei').toggle("drop", {direction: "right"}, 500);

//	    $('#gazou').toggle("drop", {direction: "up"}, 1500);
	    $('#gazou').toggle("drop", {direction: "up"}, 500);
