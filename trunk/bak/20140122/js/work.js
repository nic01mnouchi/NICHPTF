...
//  $('#midashi').toggle("drop", {direction: "left"}, 2000);
  $('#midashi').toggle("drop", {direction: "left"}, 1300);

//  $('#gazou').toggle("drop", {direction: "up"}, 3000);
  $('#gazou').toggle("drop", {direction: "up"}, 1000);

//  $('#setsumei').toggle("drop", {direction: "right"}, 2000);
  $('#setsumei').toggle("drop", {direction: "right"}, 1300);
